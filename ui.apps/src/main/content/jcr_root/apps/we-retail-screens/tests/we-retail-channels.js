...
(function(window, hobs) {
    ...
    var DEBUG = false;
    var PLAYER_PATH = '/screens/player.html';
    ...
    new hobs.TestSuite('Screens - We.Retail Channels',
        ...
        .addTestCase(new hobs.TestCase('Idle channel sequence', {
            ...
            .asserts.exists(selectors.sequence.item + ':eq(7)')
            .asserts.exists(selectors.sequence.item + ':eq(8)', false)
            .asserts.exists(selectors.sequence.item + ':eq(0):visible')
            .asserts.exists(selectors.sequence.item + ':eq(2):hidden')
            .asserts.exists(selectors.sequence.item + ':eq(4):hidden')
            .asserts.exists(selectors.sequence.item + ':eq(6):hidden')
            .wait(3000)
            ...
            .asserts.exists(selectors.sequence.item + ':eq(0):hidden')
            .asserts.exists(selectors.sequence.item + ':eq(2):hidden')
            .asserts.exists(selectors.sequence.item + ':eq(4):visible')
            .asserts.exists(selectors.sequence.item + ':eq(6):hidden')
            .wait(3000)
            .asserts.exists(selectors.sequence.item + ':eq(0):hidden')
            .asserts.exists(selectors.sequence.item + ':eq(2):hidden')
            .asserts.exists(selectors.sequence.item + ':eq(4):hidden')
            .asserts.exists(selectors.sequence.item + ':eq(6):visible')
            .wait(3000)
            .asserts.exists(selectors.sequence.item + ':eq(0):visible')
            .asserts.exists(selectors.sequence.item + ':eq(2):hidden')
            .asserts.exists(selectors.sequence.item + ':eq(4):hidden')
